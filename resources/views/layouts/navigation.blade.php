    ...
    <div class="flex flex-row h-screen">
        ...
        <div class="flex justify-center items-center bg-indigo-100 w-72">
            <div>
                ...
                <!--Annuelle-->
                @if(url()->current() == 'http://127.0.0.1:8000/sessions' || url()->current() == 'http://127.0.0.1:8000/groupessessions' || url()->current() == 'http://127.0.0.1:8000/elevesgroupes' || url()->current() == 'http://127.0.0.1:8000/periodes')
                    <button class="flex justify-center py-2 mb-6 w-full rounded-3xl @if(url()->current() == 'http://127.0.0.1:8000/sessions') bg-sky-200 border-2 border-black @else bg-sky-50 @endif "><a href="sessions">Gestion des sessions</a></button>
                ...
                <button class="flex justify-center py-2 mb-6 w-full bg-red-200 rounded-3xl"><a href="connexion">Se deconnecter</a></button>  
            </div>
        </div>
